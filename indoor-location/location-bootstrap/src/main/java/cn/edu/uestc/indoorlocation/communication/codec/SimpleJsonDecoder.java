...
public class SimpleJsonDecoder extends ByteToMessageDecoder {
    ...
    public SimpleJsonDecoder(int maxObjectLength) {
        this(maxObjectLength, false);
    }

    public SimpleJsonDecoder(boolean streamArrayElements) {
        this(1024 * 1024, streamArrayElements);
    }

    public SimpleJsonDecoder(int maxObjectLength, boolean streamArrayElements) {
